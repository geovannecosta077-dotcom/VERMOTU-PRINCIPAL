 ...
 * (e.g. `x-user-id` for lightweight server-side authorization checks).
 * Headers explicitly set on an individual call take precedence.
 * Pass `null` to clear the getter.
 */
...
export async function customFetch<T = unknown>(
  ...
  // Attach any extra headers (e.g. x-user-id) when a getter is configured,
  // without overriding headers explicitly provided on this call.
